...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-2 overflow-x-auto pb-1">
        <a href="{{ route('admin.coupons') }}" class="px-5 py-2.5 rounded-full text-xs font-bold bg-[#3D5A58] text-white shadow-xs flex items-center gap-2 shrink-0">
        ...
        <a href="{{ route('admin.tables') }}" class="px-5 py-2.5 rounded-full text-xs font-bold bg-white hover:bg-gray-100 text-gray-700 border border-[#E6DEC8] shadow-xs flex items-center gap-2 shrink-0 transition">
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
